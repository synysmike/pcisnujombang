<footer class="footer-wrapper footer-default" data-bg-src="<?php echo base_url(); ?>assets/public/assets/img/bg/footer-default-bg-mask.png">
	<!-- <div class="footer-bg-shape2 shape-mockup jump" data-top="20%" data-right="0">
		<img src="<?php echo base_url(); ?>assets/public/assets/img/shape/footer-bg-shape3.png" alt="img">
	</div>
	<div class="footer-bg-shape3 shape-mockup d-none" data-bottom="0" data-right="0">
		<img src="<?php echo base_url(); ?>assets/public/assets/img/shape/footer-bg-shape2.png" alt="img">
	</div>
