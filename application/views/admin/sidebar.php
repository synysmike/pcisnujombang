<aside id="sidebar-wrapper">
	...
	<ul class="sidebar-menu">
		...
		<?php if (in_array($this->session->userdata('user_level'), [2, 3, 4])): ?>
			<!-- Home -->
			<li class="menu-item <?php echo ($current_url == 'home') ? 'active' : ''; ?>">
				<a href="<?php echo site_url('home/ordal'); ?>" class="menu-link">
					<i class="fas fa-home"></i>
					<span class="text-truncate" data-i18n="Home">Home</span>
				</a>
			</li>
			<!-- Berita -->
			<li class="menu-item <?php echo ($current_url == 'berita') ? 'active' : ''; ?>">
		...
		<?php if (in_array($this->session->userdata('user_level'), [3, 4])): ?>
			...
			<li class="menu-item <?php echo ($current_url == 'anggota') ? 'active' : ''; ?>">
				<a href="<?php echo site_url('anggota'); ?>" class="menu-link">
					...
					<span class="text-truncate" data-i18n="Anggota">Anggota</span>
				</a>
			</li>
			<!-- Jabatan -->
			<li class="menu-item <?php echo ($current_url == 'jabatan') ? 'active' : ''; ?>">
				<a href="<?php echo site_url('jabatan'); ?>" class="menu-link">
					<i class="fas fa-briefcase"></i>
					<span class="text-truncate" data-i18n="Jabatan">Jabatan</span>
				</a>
			</li>
			<!-- Galeri -->
			<li class="menu-item <?php echo ($current_url == 'galeri') ? 'active' : ''; ?>">
		...
		<?php if (in_array($this->session->userdata('user_level'), [4])): ?>
			<!-- User -->
			<li class="menu-item <?php echo ($current_url == 'user') ? 'active' : ''; ?>">
				<a href="<?php echo site_url('user'); ?>" class="menu-link">
					<i class="fas fa-user"></i>
					<span class="text-truncate" data-i18n="User">User</span>
				</a>
			</li>
		<?php endif; ?>
		<?php if (in_array($this->session->userdata('user_level'), [2, 3, 4])): ?>
