...
var movable = function (stage, image) {
  ...
  var dragStart = function (e) {
    ...
    left = $image.position().left - (isIE8() ? 0 : Î´);
    top = $image.position().top + (isIE8() ? 0 : Î´);
...
var resizable = function (modal, stage, image, minWidth, minHeight) {
  ...
  // Î´ is the difference between image width and height
  var Î´ = 0, imgWidth = 0, imgHeight = 0, direction = '';
  ...
  var getImageOpts = function (dir, offsetX, offsetY) {
    ...
    var imgPosLeft = isIE8() ? $image.position().left + Î´ : $image.position().left;
    var imgPosTop = isIE8() ? $image.position().top - Î´ : $image.position().top;
    ...
    var imgLeft = (widthDiff > 0 ? imgPosLeft : imgPosLeft < 0 ? imgPosLeft : 0) - Î´;
    var imgTop = (heightDiff > 0 ? imgPosTop : imgPosTop < 0 ? imgPosTop : 0) + Î´;
    var imgLeft2 = (widthDiff2 > 0 ? imgPosLeft : imgPosLeft < 0 ? imgPosLeft : 0) - Î´;
    var imgTop2 = (heightDiff2 > 0 ? imgPosTop : imgPosTop < 0 ? imgPosTop : 0) + Î´;
